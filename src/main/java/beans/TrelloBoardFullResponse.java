...
public class TrelloBoardFullResponse {
    ...
    public String toString() {
        ...
        sb.append(TrelloBoardFullResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrelloBoardFullResponse) == false) {
            return false;
        }
        TrelloBoardFullResponse rhs = ((TrelloBoardFullResponse) other);
